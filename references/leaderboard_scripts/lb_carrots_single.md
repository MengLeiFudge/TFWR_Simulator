...
- 当前默认入口：`main3()`
- 当前路线：外部 `Save0/carrot.py` 修真实目标后的 5x5 单列轮转胡萝卜；不再使用 `always_not` 无限运行，而是跑到 `100,000,000 Carrot`
- 当前可靠真实时间：请求 `287` 两轮约 `23:49.323`
...
- 当前 `main3` 已补真实成绩；下一步应围绕 companion 兑现率做探针，而不是继续证明它能结算
- 重点看：
